...
ln -s "$(pwd)/project-implement" ~/.codex/skills/project-implement
# 또는: cp -r project-implement ~/.codex/skills/project-implement
```
...
배치 후 Codex CLI 세션에서 `/project-implement` 으로 호출한다.
